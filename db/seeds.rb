...
Enemy.create(name:"Goblin", attack: 10, level: 1, defense:0, sprite: "../src/images/goblin.png")
Enemy.create(name:"Ogre", attack: 15, level: 2, defense:5, sprite: "../src/images/ogre.png")
Enemy.create(name:"Dragon", attack: 20, level: 3, defense:10, sprite: "../src/images/dragon.png")
